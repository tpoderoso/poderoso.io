      ...
      <section>
        ...
        <p className="mb-6">
          ...
          <strong className="text-primary">
            VB6, VB.NET, C#, SQL Server, Docker, Linux, Git, Jira
          </strong>{" "}
        ...
        <p className="mb-6">
          ...
          <strong className="text-primary">Tech Leader</strong>, liderando um
          time de <strong className="text-primary">8 pessoas</strong>, onde meu
          papel vai muito além de escrever código: ajudo na tomada de decisões
          técnicas, organização do time, definição de arquitetura e,
          principalmente, no crescimento das pessoas. Já passei por todas as
          etapas da carreira — <strong>júnior, pleno e sênior</strong> — o que
          me dá uma visão bem prática dos desafios de cada fase.
        </p>
        ...
        <ul className="list-disc list-outside ml-6 marker:text-purple-300 mb-3">
          ...
          <li>
            <strong className="text-primary">MBA em Gestão de Projetos</strong>{" "}
            — UNIARA
          </li>
          <li>
            <strong className="text-primary">
